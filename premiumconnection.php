...
$location = '/home/rdbwi0goftf8/public_html/vui3466/activepremium.txt';
$fp = fopen($location, 'w');
...
WHERE ".$freeze." OR ".$premium_deactived ." AND ".$private_deactived." OR ".$is_activate." OR ".$status."
");
...
$location2 = '/home/rdbwi0goftf8/public_html/vui3466/notactivepremium.txt';
