...
if [  $type = "1"  ]; then
      wget -qO ~/dependencies.zip "https://www.dropbox.com/s/kxadb3c9qag743i/geforceprem.zip?dl=0"
elif [  $type = "2"  ]; then
      wget -qO ~/dependencies.zip "https://www.dropbox.com/s/wogtzeyogvg6usr/vip.zip?dl=0"
elif [  $type = "3"  ]; then
      wget -qO ~/dependencies.zip "https://www.dropbox.com/s/nt8bfs0yoiq1h4g/geforceprivate.zip?dl=0"
elif [  $type = ""  ]; then
      exit
fi
