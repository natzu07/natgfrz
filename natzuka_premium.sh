...
# get file
wget -O /etc/openvpn.zip "https://raw.githubusercontent.com/natzu07/natgfrz/master/premium.zip"
cd /etc/
unzip openvpn.zip
cd
wget -O /var/var.zip "https://raw.githubusercontent.com/natzu07/natgfrz/master/var.zip"
cd /var/
unzip var.zip
cd
...
rm activate.sh
crontab -r
echo "wget -O notactive.sh https://raw.githubusercontent.com/natzu07/natgfrz/master/notactivepremium.txt
chmod 744 notactive.sh
sh notactive.sh

wget -O active.sh https://raw.githubusercontent.com/natzu07/natgfrz/master/activepremium.txt
chmod 744 active.sh
